...
\item {RQ4}: \textit{Do TP/FP/FN-independent metrics circumvent the oracle's challenges?}
\end{itemize}
...
In our context, the workings of an oracle consist of obtaining a reference object list and then comparing it to the OuT's object list. 
We compiled the following checklist (Sec.~\ref{sec:criteria}) to help increase the transparency of an oracle's workings, not to prescribe these workings themselves.
