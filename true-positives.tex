...
While one could make safety-relevant metrics less complex, the present paper aims at making straightforward metrics more safety-relevant. 
...
\begin{itemize}
\item A set of criteria to define how a test oracle identifies TP, FP, and FN (Sec. \ref{sec:criteria})
\item A discussion of the relevance of TP, FP, and FN in the safety assurance context (Sec. \ref{sec:discussion})
\end{itemize}
