...
Ideally, novel perception metrics combine all desired properties such that they are helpful to both perception developers and verification \textit{and} validation engineers. 
...
No. After having put together the checklist (Sec.~\ref{sec:criteria}), we find that at least ReS labeling \& data processing (Sec.~\ref{sec:ref_processing}) suffers from subjective ambiguity of either human labelers or automated labeling. 
...
To alleviate the mentioned challenges, the present paper provided a comprehensive, but not provably complete, checklist of aspects that define a real-world test oracle along with guidance for characterizing each aspect. 
