...
\end{itemize}
Contrarily, the following metrics are oracle-independent (they do compare OuT and ReS object lists, but don't explicitly compute TPs, FPs, and FNs): % (they typically depend on a behavior policy and a threat metric):
\begin{itemize}
...
TODO maybe eliminate this related work altogether and just include the references where they best fit in the oracle definition?
