...
Abrecht et al. specifically focus on functional properties of deep neural networks (DNNs), which leaves non-functional aspects and implementation details of test oracles unaddressed.

To the best of our knowledge, we have not yet found a comprehensive compilation of aspects that constitute an implemented test oracle for our application.
