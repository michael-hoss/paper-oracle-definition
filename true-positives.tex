...
\subsubsection{Oracle} The mechanism that determines whether a test passes or fails, see also the survey by Barr et al. \cite{Barr2015oracle}.
...
However, for the sake of comparability of test results, the actual oracle should ideally be reproducible and therefore contain as little human intuition as possible. 
