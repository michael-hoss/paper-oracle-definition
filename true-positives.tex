...
\begin{table*}[t]
	...
	\multicolumn{2}{>{\hsize=\dimexpr0.5\hsize+0.5\tabcolsep+\arrayrulewidth\relax}X}{\textbf{Criterion}}      & \textbf{Waymo Challenge} & \textbf{Drone Testing} \\ \midrule
		a & Deterministic example 1 & stuff                    & stuff                  \\ \hline
		a & Deterministic example 2 & stuff                    & stuff                  \\ \midrule
		b & Temporal example 1      & stuff                    & stuff                  \\ \hline
		b & Temporal example 2      & stuff                    & stuff                  \\ \midrule
		c & Probabilistic example   & stuff                    & stuff
	\end{tabularx}
\end{table*}
