...
\subsubsection{Matching method} \label{def:matching_method} Those parts of the test method that influence the identification of TPs, FPs, and FNs. % based on an object list under test and a reference object list. 
...
\begin{figure*}[t]
	...
	\caption{Aspects influencing the test oracle for TPs, FPs, and FNs.
	}
...
The aspects that define the matching method, or synonymously, the test oracle for TPs, FPs, and FNs, are illustrated in Fig. \ref{fig:top_down_all}.
